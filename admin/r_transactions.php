...
<head>
    ...
    <meta content="Semantic-UI-Forest, collection of design, themes and templates for Semantic-UI."
        name="description" />
...
<body>
    ...
    SELECT order_ref,fullname,amount,account,transaction_id 
    FROM booking_details
    WHERE 
      (order_ref LIKE '%$search%' OR transaction_id LIKE '%$search%' OR account LIKE '%$search%' OR fullname LIKE '%$search%') 
      AND status = 'Rejected'
  ");
