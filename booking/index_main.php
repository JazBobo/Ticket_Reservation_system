...
<body>
    ...
    <div class="ui text container" style="margin-top:90px">
        <div id="err001" class="ui icon small attached message">
            ...
            <div class="content">
                <div class="header">Generating New Ref No.</div>
    ...
    if (isset($_SESSION['order'])) {
        ...
        if (isset($_SESSION['order']) && $_SESSION['order']['status'] != 'Rejected') {
            // Ticket generation code
        }
    }
    ?>
    <script>
        setTimeout(function () { $('#proceed').siblings().hide(); $('.gload').hide(); document.getElementById("proceed").innerHTML = "<a href='booking.php' class='ui button small green'>Book Now!</a> <a href='../admin/login.php' class='ui button small orange'>Admin Login</a> " }, 5000);
    </script>
</body>
